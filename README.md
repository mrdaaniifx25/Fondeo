...
| Objetivo superior pendiente sin cumplir | `RESULTADOS_crt_objetivo_pendiente.md` · `RESULTADOS_crt_solucion.md` | la mejor hipótesis del proyecto. Fuera de muestra, **las 12 variantes pierden** y el orden se invierte: +877 €/año dentro, −529 €/año fuera |
